...
Author page: http://twitter.com/jonnyvaughan
Plugin page: http://www.10degrees.co.uk/blog/lorem-ipsum-plugin/
Tags: lorem ipsum
...
1. Edit any page/post/custom post and use the LI button to insert text.
